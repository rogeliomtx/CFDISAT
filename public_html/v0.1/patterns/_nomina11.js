...
var Nomina = [{
    ...
    Percepciones: [{
        ...
        Percepcion: {
            ...
            TipoPercepcion: null, /* pattern: [0-9]{3} */
    ...
    SalarioDiarioIntegrado: new t_Importe()
}];
